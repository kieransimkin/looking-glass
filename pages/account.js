...
export default function Account() {
  ...
  return (
    <div>
      <Head>
        <title>iWozear - News</title>
        <meta name="description" content="iWozear - Proof of Presence. Leave a permanent record of your participation in an event at a particular time and place." />
