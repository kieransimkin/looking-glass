...
export default function Home() {
    ...
    useEffect(() => { 
      ...
      const cardanoSvg = `<?xml version="1.0" encoding="UTF-8" standalone="no"?><svg
   version="1.1"
   id="Layer_1"
   x="0px"
   y="0px"
   ...
   inkscape:zoom="5.2842713"
   inkscape:cx="187.53768"
   inkscape:cy="173.25"
   ...
   id="r4"><path
     ...
     id="path30" /></g>&#10;</svg>`
      ...
      xmlns:svg="http://www.w3.org/2000/svg">`
        console.log(cardanoSvgData.xml)
        console.log(loader.parse(xmlHeading+cardanoSvgData.xml?.children['r1'].outerHTML+`</svg>`));
    ...
    */
    ...
    <Swarm count={10000} color="#550201" />
