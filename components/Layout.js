...
const Layout = ({children}) => {
    ...
    return (
        <div id={themeState} style={{height: '100vh', fontFamily: "'MuseoModerno', cursive", backgroundColor:thisTheme.palette.background.default, color: thisTheme.palette.text.primary}}>
