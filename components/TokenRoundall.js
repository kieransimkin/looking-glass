...
export default function TokenRoundall({quantity}) { 
    ...
    return <div style={{boxShadow: '1px 2px 5px 1px rgba(0,0,0,0.5)', outline:'1px solid rgba(0,0,0,0.5)', zIndex: 200000, opacity:0.7, position: 'absolute', left: 0, top: 0, marginTop: '0.4em', marginLeft: '0.5em', marginBottom: margin,float: 'left',textAlign: 'center', borderRadius: '1.25em', width:'2.5em',height:'2.5em', background: colour, display: 'inline-block'}}>
